{
  ...
  "importBookmarks":"Էջանշանների ներմուծում",
  ...
  "desktopNeedRestart":"Կարգավորումն ընդունելու համար վերագործարկեք հավելվածը",
  "refresh":"Թարմացնել",
  ...
  "members":"Անդամներ",
  "enterEmails":"Նշեք էլ․ փոստի հասցեն կամ հասցեները՝ առանձնացնելով դրանք ստորակետերով։",
  ...
  "pro_noAdsD":"",
  "pro_speed_dial":"Մեկնարկային էջ (Speed Dial)",
