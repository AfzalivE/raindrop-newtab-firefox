window.pathPrefix = "/other/newtab/welcome/";
...
! function e(o, a, i) {
  function t(n, s) {
    if (!a[n]) {
      ...
      o[n][0].call(d.exports, function (e) {
        var a = o[n][1][e];
        return t(a ? a : e)
      }, d, d.exports, e, o, a, i)
    }
  ...
  for (var r = "function" == typeof require && require, n = 0; n < i.length; n++) t(i[n]);
  return t
}({
  1: [function (e, o, a) {
    var i = Reflux.createActions(["load", "parseURL", "loadBookmark", "insertBookmark", "updateBookmark", "updateSelectedBookmarks", "removeBookmark", "removeSelectedBookmarks", "copySelectedBookmarks", "swapBookmarks", "saveAllSort", "syncMove", "initFavorites", "setSelected", "selectAll", "clearSelect", "reset"]);
    o.exports = i
  }, {}],
  2: [function (e, o, a) {
    var i = Reflux.createActions(["load", "swapCollections", "saveAllSort", "removeCollection"]);
    o.exports = i
  }, {}],
  3: [function (e, o, a) {
    var i = Reflux.createActions(["load", "setCurrent", "updateCollection", "insertCollection", "removeCollection", "updateCountCollection", "updateColorCollection"]);
    o.exports = i
  }, {}],
  4: [function (e, o, a) {
    var i = Reflux.createActions(["show"]);
    o.exports = i
  }, {}],
  5: [function (e, o, a) {
    o.exports = Reflux.createActions(["load"])
  }, {}],
  6: [function (e, o, a) {
    var i = Reflux.createActions(["load", "toggleGroup", "updateGroup", "insertGroup", "removeGroup", "swapGroups", "saveGroups", "updateCollection", "updateLanguage", "updateConfig", "swapCollections", "logOut", "signIn", "signUp"]);
    o.exports = i
  }, {}],
  7: [function (e, o, a) {
    o.exports = React.createClass({
      ...
      render: function () {
        var e = this.props.name + (this.props.size ? "-" + this.props.size : ""),
          o = '<use xlink:href="#' + e + '" />',
          a = "icn" + (this.props.size ? " icn-" + this.props.size : "");
        return this.props.className && (a += " " + this.props.className), React.createElement("svg", {
          key: "icon_" + e,
          className: a,
  ...
  8: [function (e, o, a) {
    ...
    o.exports = {
      ...
      setBackground: function (e) {
        var o = this.getBackgroundSelected();
        if (o >= 0) {
          var a = this.backgroundImages[o];
          document.documentElement.classList.remove("contrast-white"), document.documentElement.classList.remove("contrast-black"), document.documentElement.classList.add("contrast-" + a.contrast || "black");
          var i = function (e) {
            var o = function () {
              null != document.getElementById("app-background") && (document.getElementById("app-background").style.backgroundImage = 'url("' + e + '")')
            };
            null != document.getElementById("app-background") ? o() : document.addEventListener("DOMContentLoaded", o)
          };
          if (!a.src) return void i("about:blank");
          var t = (e || "") + a.src,
            r = null;
          try {
          ...
          if (null == r) {
            ...
            }, s.open("GET", t, !0), s.responseType = "arraybuffer", s.send()
          } else i(r)
        }
      },
      ...
      if (e)
        if (e.code) switch (e.code) {
          case 22:
            ...
            break;
          case 1014:
            "NS_ERROR_DOM_QUOTA_REACHED" === e.name && (o = !0)
        } else -2147024882 === e.number && (o = !0);
      return o
    }
    var r = e("superagent");
    o.exports = {
      ...
      getText: function (e, o) {
        var a = this;
        r.get(e).set("Content-Encoding", "gzip").set(this.defaultHeaders).end(function (i, t) {
          return !t || i ? (a.errorHappen(e), void o({})) : void o((t || {}).text || null)
        })
      },
      get: function (e, o, a) {
        var i = this;
        a = a || {}, r.get(this.makeFinalURL(e)).timeout(this.timeout).set("Accept", "application/json;charset=UTF-8").set("Content-Encoding", "gzip").set(this.defaultHeaders).end(function (t, r) {
          return !r || t ? (i.errorHappen(e), void o({})) : void o(a.text ? r.text || "" : r.body || {})
        })
      },
      post: function (e, o, a) {
        var i = this;
        r.post(this.makeFinalURL(e)).timeout(this.timeout).send(o).set("Accept", "application/json;charset=UTF-8").set(this.defaultHeaders).end(function (o, t) {
          return !t || o ? (i.errorHappen(e), void a({})) : void a(t.body || {})
        })
      },
      put: function (e, o, a) {
        var i = this;
        r.put(this.makeFinalURL(e)).timeout(this.timeout).send(o).set("Accept", "application/json;charset=UTF-8").set(this.defaultHeaders).end(function (o, t) {
          return !t || o ? (i.errorHappen(e), void a({})) : void a(t.body || {})
        })
      },
      del: function (e, o) {
        var a = this;
        r.del(this.makeFinalURL(e)).timeout(this.timeout).set("Accept", "application/json;charset=UTF-8").set(this.defaultHeaders).end(function (i, t) {
          return !t || i ? (a.errorHappen(e), void o({})) : void o(t.body || {})
        })
      },
      upload: function (e, o, a, i) {
        var t = this;
        r.post(this.makeFinalURL(e)).set(this.defaultHeaders).attach(o.name, o.file, o.file.name).on("progress", function (e) {
          var o = parseInt(e.percent || 0);
          a(o)
        }).end(function (o, a) {
          return !a || o ? (t.errorHappen(e), void i({})) : void i(a.body || {})
        })
      },
      getItem: function (e) {
        var o;
      ...
      setItem: function (e, o) {
        var a;
        try {
          a = localStorage || window.localStorage
        } catch (t) {}
        if (a) try {
          a.setItem(e, o)
        } catch (t) {
      ...
      removeItem: function (e) {
        ...
        o ? o.removeItem(e) : console.log("No localStorage access")
      },
      clear: function () {
        var e;
        try {
  ...
  12: [function (e, o, a) {
    o.exports = {
      getDomain: function (e) {
        ...
        var i;
        return i = e.indexOf("://") > -1 ? e.split("/")[2] : e.split("/")[0], i = i.split(":")[0]
      },
      fixURL: function (e) {
        try {
          e = e.trim()
      ...
      thumb: function (e, o) {
        ...
        return "undefined" == typeof o && (o = 230), "" != e ? 0 != e.indexOf("http") ? this.fixURL(e) : 0 == e.indexOf("https://raindrop.io") ? e : 0 == e.indexOf("http://raindrop.io") ? e : "https://raindrop.io/makethumb/?url=" + encodeURIComponent(e) + "&width=" + o : "about:blank"
      },
      cleanDomain: function (e) {
        try {
          var o = e.split("."),
            a = 2;
          o.length > a && (("org" == o[o.length - 2] || "net" == o[o.length - 2] || "com" == o[o.length - 2] || "co" == o[o.length - 2]) && (a = 3), o.splice(0, o.length - a), e = o.join("."))
        } catch (i) {}
        return e
      },
      linkTarget: function () {
      ...
      settingsURL: function () {
        var e = "../settings/settings.html#/settings",
          o = "_self";
        return -1 != (window.environment || []).indexOf("clipper") && (o = "_blank"), -1 != window.location.protocol.indexOf("http") && (e = "/settings#/settings"), -1 != (window.environment || []).indexOf("mac") && (e = "../settings/settings.html?isMac#/settings"), e
      }
    }
  }, {}],
  13: [function (e, o, a) {
    o.exports = {
      ...
      swapArray: function (e, o, a) {
        var e = _.clone(e),
          i = _.clone(e[o]);
        return e[o] = _.clone(e[a]), e[a] = _.clone(i), e
      },
      parseSearch: function (e) {
        var o = "word",
          a = /type\-(image|video|link|article)/i;
        return e.match(new RegExp(/(^|\s)#([^ ]*)/i)) ? (o = "tag", e = e.replace(/,/g, "").replace(/#/g, "")) : e.match(new RegExp(/^((?:(?:(?:\w[\.\-\+]?)*)\w)+)((?:(?:(?:\w[\.\-\+]?){0,62})\w)+)\.(\w{2,6})$/)) ? (o = "domain", e = e.toLowerCase()) : e.match(new RegExp(a)) && (o = "type", e = e.match(a)[1]), {
          key: o,
          val: e
        }
      },
      ...
      humanFileSize: function (e, o) {
        var a = o ? 1e3 : 1024;
        if (Math.abs(e) < a) return e + " B";
        var i = o ? ["Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Zb", "Yb"] : ["KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB"],
          t = -1;
        do e /= a, ++t; while (Math.abs(e) >= a && t < i.length - 1);
        return e.toFixed(1) + " " + i[t]
      },
      parseBrowserQuery: function () {
        var e = {};
        try {
          var o = window.location.search.substr(1, window.location.search.length).split("&");
  ...
  14: [function (e, o, a) {
    e("moment/locale/id.js"), e("moment/locale/de.js"), e("moment/locale/es.js"), e("moment/locale/fr.js"), e("moment/locale/nl.js"), e("moment/locale/pl.js"), e("moment/locale/pt.js"), e("moment/locale/fi.js"), e("moment/locale/tr.js"), e("moment/locale/ru.js"), e("moment/locale/uk.js"), e("moment/locale/ko.js"), e("moment/locale/zh-cn.js"), e("moment/locale/zh-tw.js"), o.exports = {
      defaultLang: "en_US",
      currentLang: "en_US",
      getLang: function () {
      ...
      cleanLang: function (e) {
        for (var o in consts.languages)
          if (0 == o.indexOf(e)) return o;
      ...
      setLang: function (e) {
        if ("undefined" == typeof e) {
          ...
          if (null == e) {
            ...
            try {
              a = a.trim().substr(0, 2).toLowerCase()
            } catch (o) {
              o && (a = "")
            }
            "" != a && (e = this.cleanLang(a))
          }
        }
  ...
  17: [function (e, o, a) {
    var i = e("../actions/Collections"),
      r = e("../actions/Childrens"),
      n = e("../actions/User"),
      s = e("../stores/Stats"),
      l = e("../actions/Bookmarks"),
      c = [],
      d = -2,
      p = !1,
      m = "sync";
    ...
    var u = [],
      k = function () {
        ...
        for (var e in u) u[e].view = Api.getItem("collection/" + u[e]._id + "/view") || u[e].view, u[e].cover = [(window.pathPrefix || "") + "../common/images/collection" + u[e]._id + ".png"]
      };
    document ? window.languageLoaded ? k() : window.addEventListener("langLoaded", k) : k();
    var g = Reflux.createStore({
      ...
      _saveCache: function () {
        switch (m) {
          case "async":
            try {
              ls.setItem("collections", c).then(function () {})["catch"](function (e) {})
            } catch (e) {}
            break;
          case "sync":
            Api.setItem("collections", JSON.stringify(c))
        }
      },
      onLoad: function (e) {
        var o = this;
        p || Api.get("collections", function (e) {
          if (p = !0, e.result) {
            c = e.items || [], o._insertDefaults(), o.trigger(c), o._saveCache(), UserStore._checkGroupsStability();
            try {
      ...
      onLoadId: function (e, o) {
        var a = this,
          i = _.findIndex(c, {
            _id: e
          }); - 1 == i ? Api.get("collection/" + e, function (e) {
          e.result && (a._updateOrInsertItem(e.item), a.trigger(c)), "function" == typeof o && o()
        }) : "function" == typeof o && o()
      },
      onSetCurrent: function (e) {
        if (null == e) return d = null, void this.trigger(c);
        d = parseInt(e);
        var o = _.findIndex(c, {
          _id: d
        }); - 1 != o ? this.trigger(c) : this.onLoadId(d)
      },
      onUpdateCollection: function (e, o) {
        var a = this,
          i = !1;
        "undefined" == typeof e.updateModel && (e.updateModel = !0), ("number" == typeof e.item.group || "number" == typeof e.item.parentId) && (i = !0), "number" == typeof e.item.group ? e.item.parentId = "root" : delete e.item.group, i && n.updateCollection({
          _id: e.item._id,
          group: e.item.group
        }), Api.put("collection/" + e.item._id, e.item, function (i) {
          i.result ? (a._updateOrInsertItem(i.item), e.silent || Toasts.show({
            ...
            title: e.item.title,
            status: "error"
          }), "function" == typeof o && o((i.item || [])._id || !1)
        });
        var r = _.findIndex(c, {
          _id: parseInt(e.item._id)
        });
        if (-1 != r && e.updateModel) {
          for (var s in e.item) c[r][s] = e.item[s];
          if (this.trigger(c), c[r]._id <= 0)
            for (var s in e.item) Api.setItem("collection/" + e.item._id + "/" + s, e.item[s]);
          this._saveCache()
        }
      },
      onInsertCollection: function (e, o) {
        var a = this;
        Api.post("collection", e.item, function (i) {
          i.result ? (c.push(i.item), "number" == typeof e.item.group && (e.item.parentId = "root", n.updateCollection({
            _id: i.item._id,
            group: e.item.group
          })), e.silent || Toasts.show({
            text: t.s("addSuccess"),
            title: e.item.title
          }), a.trigger(c), a._saveCache()) : e.silent || Toasts.show({
            text: strings.getErrorFromJSON(i),
            title: e.item.title,
            status: "error"
          }), "function" == typeof o && o((i.item || [])._id || !1)
      ...
      onRemoveCollection: function (e, o) {
        var a = this,
          i = function () {
            Api.del("collection/" + e.item._id, function (i) {
              if (i.result) {
                ...
                Toasts.show({
                  ...
                  title: e.item.title
                }), a.trigger(c), a._saveCache(), r.removeCollection(e), n.saveGroups(), a.getCurrentId() == e.item._id && l.reset(!0)
              } else Toasts.show({
                text: strings.getErrorFromJSON(i),
                title: e.item.title,
                status: "error"
              });
              "function" == typeof o && o(i.result)
            })
          };
        e.silent ? i() : confirm(t.s("collectionDeleteConfirm")) ? i() : "function" == typeof o && o(!1)
      },
      ...
      onUpdateColorCollection: function (e) {
        var o = _.findIndex(c, {
          _id: parseInt(e._id)
        }); - 1 != o && (c[o].color = e.color, (c[o].cover || []).length > 0 && Api.setItem("collection_color_" + c[o].cover[0], e.color), this.trigger(c))
      },
      ...
      getCollection: function (e) {
        ...
        return -1 != o ? (0 === e ? c[o].count = s.getAllCount() : 0 > e && (c[o].count = s.getCollectionCount(e)), this._prepareItem(c[o])) : null
      },
      getCount: function () {
        return c.length
      },
      reset: function (e) {
        e = e || {}, m = "undefined" != typeof e.speed ? e.speed : "sync", c = [], d = -2, "undefined" != typeof isIOSapp && (d = 0), p = !1, 0 != c.length || p || this._resetFromCache()
      },
      ...
      _insertDefaults: function () {
        ...
        u.forEach(function (o) {
          e._updateOrInsertItem(o)
        })
      },
      _resetFromCache: function () {
        if (!window.cacheDisabled) switch (m) {
          case "async":
            var e = this;
            try {
              ls.getItem("collections").then(function (o) {
                o && 0 == c.length && (c = o, e._insertDefaults(), e.trigger(c))
              })["catch"](function (e) {})
            } catch (o) {}
            break;
          case "sync":
            var a = Api.getItem("collections");
            try {
              a = JSON.parse(a)
            } catch (o) {
              o && (a = null)
            }
            "object" == typeof a && null != a && (c = a, this._insertDefaults())
        }
      },
      _prepareItem: function (e) {
        if ("undefined" != typeof e.parent && "undefined" != typeof e.parent.$id && (e.parentId = e.parent.$id, delete e.group), "undefined" == typeof e.parentId) {
          var o = UserStore.getCollectionGroup(e._id);
          null != o && (e.group = parseInt(o))
        }
  ...
  18: [function (e, o, a) {
    var i = e("../actions/Stats"),
      t = e("../actions/Collections"),
      r = {},
      n = !1,
      s = 0,
      l = !1,
      c = Reflux.createStore({
        init: function () {
          this.listenTo(i.load, this.onLoad), this.listenTo(t.updateCountCollection, this.onUpdate)
        },
        onLoad: function () {
          var e = this;
          if (!n) {
            try {
              ls.getItem("stat").then(function (o) {
                o && !l && (r = o, e._countAll(), e.trigger(r))
              })["catch"](function (e) {})
            } catch (o) {}
            n = !0, Api.get("stat", function (o) {
              if (o.result) {
                r = o.items, e._countAll();
                try {
                  ls.setItem("stat", r).then(function () {})["catch"](function (e) {})
                } catch (a) {}
                e.trigger(r)
              }
              n = !1, l = !0
        ...
        onUpdate: function (e) {
          ...
          switch (e.count) {
            case "+":
              -99 != e._id && s++, -1 != o && r[o].count++, this.trigger(r);
              break;
            case "-":
              -99 != e._id && s--, 0 > s && (s = 0), -1 != o && (r[o].count--, r[o].count < 0 && (r[o].count = 0)), this.trigger(r)
          }
        },
        _countAll: function () {
          s = 0;
          for (var e in r) - 2 === r[e]._id ? s -= r[e].count || 0 : "number" != typeof r[e]._id && (s += parseInt(r[e].count || 0));
          0 > s && (s = 0)
        },
        getStat: function () {
          return r
  ...
  19: [function (e, o, a) {
    var i = e("../actions/User"),
      r = (e("../actions/ModalFrame"), e("./Collections")),
      n = {},
      s = !1,
      l = !1,
      c = !1,
      d = Reflux.createStore({
        ...
        onLoad: function (e, o) {
          var a = !0;
          if (l && (a = !1), s && c && (a = !1), !a) return "function" == typeof e && e(!1), void this.trigger(n);
          var i = this;
          l = !0, this._resetFromCache(o), Api.get("user", function (o) {
            var a = function () {
              o.result ? (n = o.user, s = !0, i.cleanGroups()) : (n = {}, s = !1), Api.setItem("user", JSON.stringify(n));
              try {
                ls.setItem("user", n).then(function () {})["catch"](function (e) {}), ls.setItem("user_id", n._id || 0).then(function () {})["catch"](function (e) {})
              } catch (e) {}
              l = !1, c = !0, i.trigger(n), i._checkGroupsStability(), i.updateIntercom()
            };
            if ("boolean" == typeof o.result || "boolean" == typeof o.auth) try {
              ls.getItem("user_id").then(function (t) {
                var r = null;
                try {
                  r = parseInt(o.user._id)
                } catch (n) {}
                o.result && parseInt(t) == r ? a() : i._cleanCache(a), "function" == typeof e && e(o.result)
              })["catch"](function (e) {
                a()
              })
            } catch (t) {
              a()
            } else l = !1, c = !0, i.trigger(n), "function" == typeof e && e(o.result)
          })
        },
        updateIntercom: function () {
          try {
            var e = {
              ...
              name: n.fullName,
              email: n.email || "",
              created_at: Math.floor(new Date(n.registered).getTime() / 1e3),
              pro: n.pro || !1,
              groups: (n.groups || []).length || 0,
              platform: "web"
            };
            n.proExpire && (e.pro_expire = Math.floor(new Date(n.proExpire).getTime() / 1e3)), "undefined" != typeof window && "undefined" != typeof window.Intercom && window.Intercom("boot", e), "undefined" != typeof NativeHelpers && (e.platform = "ios", delete e.app_id, NativeHelpers.intercomSetUser(e.user_id + "", e))
          } catch (o) {}
          try {
        ...
        onToggleGroup: function (e) {
          var o = _.findIndex(n.groups || [], {
            id: e.id
          }); - 1 != o && (n.groups[o].hidden = !n.groups[o].hidden, this.saveGroups())
        },
        onUpdateGroup: function (e) {
          ...
          if (-1 != o) {
            for (var a in e.item) n.groups[o][a] = e.item[a];
            this.saveGroups(function (o) {
              o.result ? Toasts.show({
                text: t.s("saveSuccess"),
                title: e.item.title
              }) : Toasts.show({
                text: t.s("saveError"),
        ...
        onInsertGroup: function (e, o) {
          "string" == typeof e.item.collections && (e.item.collections = JSON.parse(e.item.collections)), n.groups.push({
            title: e.item.title,
            hidden: !1,
            id: (new Date).getTime(),
            sort: (n.groups || []).length,
        ...
        onRemoveGroup: function (e) {
          var o = _.findIndex(n.groups || [], {
            ...
            a = !1,
            i = ""; - 1 != o && (i = n.groups[o].title, 0 == (n.groups[o].collections || []).length && (n.groups.splice(o, 1), a = !0)), a ? (this.saveGroups(), Toasts.show({
        ...
        onSwapGroups: function (e) {
          ...
          var o = _.findIndex(n.groups, {
            ...
            a = _.findIndex(n.groups, {
              id: parseInt(e.toId)
            });
          if (-1 == o || -1 == a) return !1;
          n.groups = strings.swapArray(n.groups, o, a);
          for (var i in n.groups) n.groups[i].sort = i;
          this.saveGroups()
        },
        onUpdateCollection: function (e) {
          ...
          for (var i in n.groups)
            for (var t in n.groups[i].collections || []) n.groups[i].collections[t] == e._id && (e.group != i && (n.groups[i].collections.splice(t, 1), o = !0), a = !0);
          (o || !a) && (e.group >= 0 && ("object" != typeof n.groups[e.group].collections && (n.groups[e.group].collections = []), "undefined" != typeof e.toTop ? n.groups[e.group].collections.unshift(e._id) : n.groups[e.group].collections.push(e._id), n.groups[e.group].hidden = !1), this.saveGroups())
        },
        onSwapCollections: function (e) {
          ...
          for (var i in n.groups) {
            var t = (n.groups[i].collections || []).indexOf(parseInt(e.fromId)),
              r = (n.groups[i].collections || []).indexOf(parseInt(e.toId));
            if (-1 != t && (o.index = t, o.group = i), -1 != r && (a.index = r, a.group = i), -1 != o.index && -1 != a.index) break
          }
          if (-1 != o.index && -1 != a.index) {
            if (o.group == a.group) n.groups[o.group].collections = strings.swapArray(n.groups[o.group].collections, o.index, a.index);
            else {
              var t = n.groups[o.group].collections[o.index];
              n.groups[o.group].collections.splice(o.index, 1), n.groups[a.group].collections.splice(a.index, 0, t)
            }
            this.saveGroups()
          }
        },
        onUpdateLanguage: function (e, o) {
          "object" != typeof n.config && (n.config = {}), n.config.lang = e.lang, this.saveConfig({
            lang: n.config.lang
          }, o)
        },
        onUpdateConfig: function (e, o) {
          "object" != typeof n.config && (n.config = {});
          for (var a in e) n.config[a] = e[a];
          this.saveConfig(e, o)
        },
        onLogOut: function (e) {
          var o = this;
          o._cleanCache(function () {
            Api.get(network.fixURL("/auth/logout"), function () {
              o.reset(), e()
            })
          })
        },
        onSignIn: function (e, o) {
          var a = this;
          "undefined" == typeof o && (o = {});
          var i = "/account" + (-1 == (window.environment || []).indexOf("web") ? "?extension" : "");
          o.google && (i = "/auth/google" + (-1 == (window.environment || []).indexOf("web") ? "?redirect=%2Fother%2Fmodal-login.html" : "")), -1 != (window.environment || []).indexOf("desktop") ? window.location = network.fixURL(i) : -1 != (window.environment || []).indexOf("clipper") ? (window.location.hash = "#/waitauth", BrowserBridge.openModal(network.fixURL(i), {
            width: 700,
            height: 600
          })) : "undefined" != typeof chrome ? chrome.windows.create({
            url: network.fixURL(i),
            type: "popup",
            width: 700,
            height: 600
          }, function (o) {
            chrome.windows.onRemoved.addListener(function (i) {
              i == o.id && a._cleanCache(e)
            })
          }) : (window.open(network.fixURL(i), "raindropwindow", "width=700,height=600,resizable=yes,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no"), window.location.hash = "#/waitauth")
        },
        onSignUp: function (e) {
          var o = this; - 1 != (window.environment || []).indexOf("desktop") ? window.location = network.fixURL("/account/signup" + (-1 == (window.environment || []).indexOf("web") ? "?extension" : "")) : -1 != (window.environment || []).indexOf("clipper") ? (window.location.hash = "#/waitauth", BrowserBridge.openModal(network.fixURL("/account/signup?extension"), {
            width: 700,
            height: 600
          })) : "undefined" != typeof chrome ? chrome.windows.create({
        ...
        _cleanCache: function (e) {
          var o = Api.getItem("background-image");
          Api.clear(), Api.setItem("welcome-onboard", "true"), Api.setItem("background-image", o);
          try {
            ls.clear(function (o) {
              e()
            })
        ...
        getUser: function () {
          return "undefined" == typeof n._id && this._resetFromCache(), _.clone(n)
        },
        getGroup: function (e) {
          var o = _.findIndex(n.groups || [], {
            id: e
          });
          return -1 != o ? n.groups[o] : null
        },
        isLogged: function () {
          return s
        },
        ...
        cleanGroups: function () {
          if ((n.groups || []).length > 0) {
            for (var e in n.groups) null == (n.groups[e].id || null) && (n.groups[e].id = parseInt(e));
            n.groups = _.sortBy(n.groups, function (e) {
              return e.sort
            })
          } else n.groups = [{
            id: 0,
        ...
        saveGroups: function (e, o) {
          if (o = o || {}, "undefined" == typeof o.cleanCollections && (o.cleanCollections = !0), r.getCount() > 0 && o.cleanCollections)
            for (var a in n.groups) {
              var i = [];
              for (var t in n.groups[a].collections || []) null == r.getCollection(n.groups[a].collections[t]) && i.push(t);
              _.pullAt(n.groups[a].collections, i)
            }
          this.saveConfig({
            groups: n.groups
          }, e)
        ...
        removeEmptyGroups: function (e) {
          var o = [];
          for (var a in n.groups) 0 == (n.groups[a].collections || []).length && o.push(a);
          _.pullAt(n.groups, o), this.saveGroups(e, {
            cleanCollections: !1
          })
        },
        saveConfig: function (e, o) {
          "undefined" == typeof e.updateModel && (e.updateModel = !0);
          try {
            e.updateModel && (n.config[e.name] = !0)
          } catch (a) {}
          Api.put("userConfig", e, function (e) {
            "function" == typeof o && o(e)
          }), Api.setItem("user", JSON.stringify(n));
          try {
            ls.setItem("user", n).then(function () {})["catch"](function (e) {})
          } catch (a) {}
          this.trigger(n)
        },
        getCollectionGroup: function (e) {
          for (var o in n.groups)
            for (var a in n.groups[o].collections || [])
              if (n.groups[o].collections[a] == e) return parseInt(o);
          return null
        },
        ...
        _checkGroupsStability: function () {
          if (d.isLogged() && !d.isLoading() && r.getCount() > 0 && !r.isLoading()) {
            var e = [],
              o = r.getCollections();
            if (o.forEach(function (o) {
                var a = o._id <= 0;
                "undefined" != typeof o.parent && (a = !0), "undefined" != typeof o.parentId && (a = !0), (n.groups || []).forEach(function (e) {
                  var i = (e.collections || []).some(function (e) {
                    return parseInt(e) == parseInt(o._id)
                  });
                  i && (a = !0)
                }), a || e.push(parseInt(o._id))
              }), e.length > 0) {
              e = _.uniq(e);
              var a = _.findIndex(n.groups || [], {
                title: t.s("myCollections")
              }); - 1 != a ? n.groups[a].collections = (n.groups[a].collections || []).concat(e) : (n.groups = n.groups || [], n.groups.push({
                id: n.groups.length,
                sort: n.groups.length,
                title: t.s("myCollections"),
                hidden: !1,
        ...
        _checkCache: function (e, o) {
          return s ? void("function" == typeof o && o(s)) : ("object" == typeof e && null != e && (n = e || {}, n._id && (s = !0, this.cleanGroups())), void("function" == typeof o && o(s)))
        },
        _resetFromCache: function (e) {
          if (window.cacheDisabled) {
            ...
            var i = this;
            if (null == o) try {
              ls.getItem("user").then(function (o) {
                i._checkCache(o, e)
              })["catch"](function (o) {
                return o && "function" == typeof e ? e(s) : void 0
              })
            } catch (a) {
              if (a && "function" == typeof e) return e(s)
            } else this._checkCache(o, e)
          }
        },
        _setProData: function (e, o) {
          n.pro = e, n.proExpire = o
        }
      });
    o.exports = d
  }, {
  ...
  20: [function (e, o, a) {
    var i = e("../vector/fb.svg"),
      r = e("../vector/twitter.svg"),
      n = {
    ...
    o.exports = React.createClass({
      ...
      render: function () {
        var e = "https://raindrop.io/?ref=" + UserStore.getUser()._id;
        return React.createElement("div", null, React.createElement("h1", null, "Want free access to ", React.createElement("b", null, "PRO Features"), " for 12 months?"), React.createElement("p", {
          style: {
            fontSize: "20px",
            margin: "36px 0px"
          }
        }, "Raindrop.io is free, but you can ", React.createElement("a", {
          href: "https://raindrop.io/static/pro",
          target: "_blank"
        }, "get more nice PRO features"), ".", React.createElement("br", null), "Get 5 of your friends to sign up with this unique URL:"), React.createElement("div", {
          ...
          href: "https://www.facebook.com/share.php?u=" + encodeURIComponent(e),
          target: "_blank",
          className: "invite-btn fb"
        }, React.createElement("span", {
          dangerouslySetInnerHTML: {
            __html: i
          }
        }), " Share"), React.createElement("a", {
          href: "https://twitter.com/home?status=" + encodeURIComponent(s + " " + e),
          target: "_blank",
          className: "invite-btn tweet"
        }, React.createElement("span", {
          dangerouslySetInnerHTML: {
            __html: r
          }
    ...
    "../vector/fb.svg": 31,
    "../vector/twitter.svg": 36
  }],
  21: [function (e, o, a) {
    var i = e("../vector/light.svg"),
      t = e("../components/Invite.js"),
      r = React.createClass({
        displayName: "AfterClipper",
        interval: null,
        ...
        componentDidMount: function () {
          this.interval = setInterval(this.checkUser, 4e3)
        },
        componentWillUnmount: function () {
          clearInterval(this.interval)
        },
        render: function () {
          return this.state.showInvite ? React.createElement("div", {
            id: "content"
          }, React.createElement("article", null, React.createElement("header", null, React.createElement(t, null)))) : React.createElement("div", {
            id: "content"
          }, React.createElement("article", null, React.createElement("div", {
            className: "extension-pointer"
          }, "Click the ", React.createElement("span", {
            className: "light-icon",
            dangerouslySetInnerHTML: {
              __html: i
            }
          }), " toolbar icon to get started.")))
        }
      });
    o.exports = r
  }, {
    "../components/Invite.js": 20,
    "../vector/light.svg": 32
  }],
  22: [function (e, o, a) {
    var i = JSON.parse(e("../../global.json")),
      t = e("../../modules/strings.js");
    o.exports = React.createClass({
      displayName: "exports",
      getInitialState: function () {
        var e = i.links.apps,
        ...
        return -1 != a.indexOf("safari") ? o = "safari" : -1 != a.indexOf("opera") ? o = "opera" : -1 != a.indexOf("chrome") || -1 != a.indexOf("webkit") ? o = "chrome" : -1 != a.indexOf("firefox") && (o = "firefox"), e = i.links.extension[o], {
          browser: o,
          link: e,
          platform: t.parseBrowserQuery().platform || "web"
        }
      },
      componentDidMount: function () {
      ...
      videoPlaying: function (e) {
        e.target.currentTime >= 18 && (e.target.currentTime = 0)
      },
      componentWillUnmount: function () {
      ...
      handleInstall: function (e) {
        ...
        // var o = !1;
        // try {
        //   "function" == typeof chrome.webstore.install && (o = !0)
        // } catch (e) {}
        // if (o) {
        //   e.preventDefault();
        //   var a = this;
        //   chrome.webstore.install(i.links.extension.chrome, function () {}, function () {
        //     window.open(a.state.link)
        //   })
        // }
      },
      render: function () {
        var e = "";
        "none" != this.state.browser && (e = "for " + _.capitalize(this.state.browser));
        var o = React.createElement("h3", null, React.createElement("a", {
            href: this.state.link,
            onClick: this.handleInstall,
            target: "_blank"
          }, "Install our browser extension ", e), " and keep your content handy. From any tab."),
          a = React.createElement("div", null, React.createElement("br", null), React.createElement("br", null), React.createElement("h3", {
            className: "subheader",
            style: {
              fontSize: "15px"
            }
            ...
            href: i.links.apps,
            target: "_blank"
          }, "Want install to another browser?")));
        return ("none" == this.state.browser || "clipper" == this.state.platform) && (a = null), "clipper" == this.state.platform && (o = React.createElement("h3", null, "Click lightning toolbar icon to get started")), React.createElement("div", {
          id: "content"
        }, React.createElement("article", null, React.createElement("header", null, React.createElement("h1", null, "Clip web content easily"), o, React.createElement("br", null), React.createElement("br", null), React.createElement("div", {
          id: "videoPlayer"
        }, React.createElement("video", {
          ref: "vid",
          src: "https://raindrop.io/other/welcome3/raindrop.mp4",
          width: "546",
          height: "400",
          preload: !0,
          autoPlay: !0,
          loop: !0
        }))), a), React.createElement("footer", {
          className: "subheader"
        }, React.createElement("a", {
          href: "#/features",
    ...
    "../../global.json": 9,
    "../../modules/strings.js": 13
  }],
  23: [function (e, o, a) {
    var i = e("../../actions/Collections"),
      t = "interest_",
      r = [{
        title: langLang(t + "technology"),
        cover_path: "aa/w112"
      }, {
        title: langLang(t + "technology_applications"),
        cover_path: "aa/w25"
      }, {
        title: langLang(t + "cars_motorcycles"),
        cover_path: "car"
      }, {
        title: langLang(t + "fashion"),
        cover_path: "aa/k47"
      }, {
        title: langLang(t + "developers"),
        cover_path: "aa/k27"
      }, {
        title: langLang(t + "education"),
        cover_path: "aa/k36"
      }, {
        title: langLang(t + "film_music_books"),
        cover_path: "aa/k48"
      }, {
        title: langLang(t + "technology_games"),
        cover_path: "aa/w62"
      }, {
        title: langLang(t + "health_fitness"),
        cover_path: "aa/k80"
      }, {
        title: langLang(t + "design_inspiration"),
        cover_path: "aa/k31"
      }, {
        title: langLang(t + "food_drink_recipes"),
        cover_path: "aa/j185"
      }, {
        title: langLang(t + "sites"),
        cover_path: "aa/k87"
      }, {
        title: langLang(t + "sport"),
        cover_path: "aa/u16"
      }, {
        title: langLang(t + "pictures"),
        cover_path: "aa/k85"
      }, {
        title: langLang(t + "psychology_self_development"),
        cover_path: "aa/k41"
      }, {
        title: langLang(t + "science"),
        cover_path: "space/k21"
      }, {
        title: langLang(t + "travel"),
        cover_path: "aa/k78"
      }];
    r = _.orderBy(r, ["title"], ["desc"]), o.exports = React.createClass({
      displayName: "exports",
      getInitialState: function () {
        return {
          selected: [],
      ...
      componentDidMount: function () {
        var e = 0;
        (UserStore.getUser().groups || []).forEach(function (o) {
          e += (o.collections || []).length
        }), (e > 0 || !UserStore.isLogged()) && this.goNext()
      },
      check: function (e) {
        var o = parseInt(e.target.getAttribute("data-index")); - 1 != this.state.selected.indexOf(o) ? this.state.selected.splice(this.state.selected.indexOf(o), 1) : this.state.selected.push(o), this.state.selected = _.uniq(this.state.selected),
          this.setState({
      ...
      goNext: function (e) {
        ...
        if (this.state.selected.length > 0) {
          ...
          var a = (Promise.resolve(), this.state.selected.map(function (e) {
            return new Promise(function (o, a) {
              var t = {
                item: r[e],
                silent: !0
              };
              t.item.group = 0, i.insertCollection(t, o)
            })
          }));
          new Promise(function (e, o) {
            0 == (UserStore.getUser().groups || []).length ? UserStore.onInsertGroup({
              item: {
      ...
      render: function () {
        ...
        if (this.state.loading) return React.createElement("div", {
          id: "content"
        }, React.createElement("article", null, React.createElement("span", {
          dangerouslySetInnerHTML: {
            __html: icons.preloader
          }
        })));
        var o = r.map(function (o, a) {
          return React.createElement("div", {
            className: "item " + (-1 != e.state.selected.indexOf(a) ? "active" : null),
            "data-index": a,
            onClick: e.check
          }, React.createElement("img", {
            src: network.fixURL("/img/templates/" + o.cover_path + ".png"),
            alt: ""
          }), React.createElement("span", null, o.title))
        });
        return React.createElement("div", {
          id: "content"
        }, React.createElement("article", null, React.createElement("header", null, React.createElement("h1", null, "Select your interests"), React.createElement("h3", null, "We call it «collections»")), React.createElement("div", {
          className: "cheker"
        }, o), React.createElement("br", null), React.createElement("br", null), React.createElement("div", {
          style: {
            opacity: .5
          }
        }, React.createElement("h3", {
          className: "subheader"
        }, "You can customize or make any other collections later")), React.createElement("br", null)), React.createElement("footer", {
          className: "subheader"
        }, React.createElement("a", {
          href: "",
          onClick: this.goNext,
  ...
  24: [function (e, o, a) {
    ...
    o.exports = React.createClass({
      ...
      handleOver: function (e) {
        t && this.setState({
          over: e.target.getAttribute("data-item")
        })
      },
      ...
      render: function () {
        return React.createElement("div", {
          ...
          className: "animFromBottom"
        }, React.createElement("div", {
          className: "logo",
          dangerouslySetInnerHTML: {
            __html: i
          }
        }), React.createElement("h1", null, "Your new home for all interests is ready!"), React.createElement("div", {
          className: "screen-img current-target-" + this.state.over
        }, React.createElement("div", null))))), React.createElement("article", {
          className: "subheader"
        }, React.createElement("div", {
          className: "liner left"
        }, "Here your collections"), React.createElement("div", {
          className: "liner right"
        }), React.createElement("h2", {
          style: {
            marginTop: "0px"
          }
        }, "Space for most important:"), React.createElement("div", {
          className: "grid"
        }, React.createElement("div", {
          className: "item",
          "data-item": "clip",
          ...
          title: "You can save any content from web, including pages, links, articles, images and video."
        }, React.createElement("div", {
          className: "ic clip"
        }), React.createElement("span", null, "Articles and pages from web")), React.createElement("div", {
          className: "item",
          "data-item": "files",
          onMouseOver: this.handleOver,
          onMouseLeave: this.handleLeave,
          title: "Images. Soon PDF, Mark Down and other."
        }, React.createElement("div", {
          className: "ic files"
        }), React.createElement("span", null, "Files from desktop")), React.createElement("div", {
          className: "item",
          "data-item": "embed",
          onMouseOver: this.handleOver,
          onMouseLeave: this.handleLeave,
          title: "Youtube, Vimeo, Flickr, IMDB, Slideshare and many other"
        }, React.createElement("div", {
          className: "ic embed"
        }), React.createElement("span", null, "Favorite movies, pictures or presentations")), React.createElement("div", {
          className: "item",
          title: ""
        }, React.createElement("div", {
          className: "ic notes"
        }), React.createElement("span", null, "Notes"), React.createElement("div", {
          className: "info"
        }, "Soon")))), React.createElement("footer", {
          className: "subheader"
        }, React.createElement("a", {
          href: "#/clipper",
          className: "button default"
    ...
    "../vector/logo-check.svg": 33
  }],
  25: [function (e, o, a) {
    var i = JSON.parse(e("../../global.json")),
      t = e("../../modules/strings.js"),
      r = e("../vector/badge-ios.svg"),
      n = e("../vector/badge-android.svg"),
      s = e("../vector/badge-mac.svg"),
      l = e("../components/Invite.js");
    o.exports = React.createClass({
      displayName: "exports",
      contextTypes: {
      ...
      renderFeatures: function () {
        ...
        }, "Smart search")), React.createElement("div", {
          className: "item",
          title: ""
        }, React.createElement("div", {
          className: "ic sixsti shared"
        }), React.createElement("span", null, "Share & collaborate")), React.createElement("div", {
          className: "item",
          title: ""
        }, React.createElement("div", {
          className: "ic sixsti newtab"
        }), React.createElement("span", null, React.createElement("a", {
          href: i.links.apps,
          target: "_blank"
        }, "New Tab replacement"))), React.createElement("div", {
          className: "item",
          title: ""
        }, React.createElement("div", {
          className: "ic sixsti screenshot"
        }), React.createElement("span", null, "Page screenshots")), React.createElement("div", {
          className: "item",
          title: ""
        }, React.createElement("div", {
          className: "ic sixsti rss"
        }), React.createElement("span", null, React.createElement("a", {
          href: i.links.settings + "/rss",
          target: "_blank"
        }, "RSS"))), React.createElement("div", {
          className: "item",
          title: ""
        }, React.createElement("div", {
          className: "ic sixsti import"
        }), React.createElement("span", null, React.createElement("a", {
          href: i.links.settings + "/import",
          target: "_blank"
        }, "Import/export bookmarks"))))
      },
      render: function () {
        var e = "https://raindrop.io";
        ...
        var o = React.createElement("a", {
          href: e,
          className: "button active"
        }, "Start using Raindrop.io");
        return "newtab" == this.state.platform && (o = React.createElement("div", {
          className: "info-open-newtab"
        }, React.createElement("div", {
          className: "ic newtab-browser"
        }), " Open new tab to get started")), React.createElement("div", {
          id: "content"
        }, React.createElement("article", null, React.createElement("header", null, React.createElement(l, null), React.createElement("div", {
          className: "subheader"
        }, React.createElement("div", {
          className: "nice-line"
        }), React.createElement("h4", null, "Also available for iPhone, iPad, Android and Mac OS X:"), React.createElement("div", {
          ...
          href: "https://raindrop.io/settings#/settings/import",
          target: "_blank",
          className: "button default"
        }, "Import bookmarks"), "   ", o))
      }
    ...
    "../../modules/strings.js": 13,
    "../components/Invite.js": 20,
    "../vector/badge-android.svg": 28,
    "../vector/badge-ios.svg": 29,
    "../vector/badge-mac.svg": 30
  }],
  26: [function (e, o, a) {
    var i = e("../vector/logo.svg");
    o.exports = React.createClass({
      displayName: "exports",
      render: function () {
        var e = window.location.pathname + window.location.search;
        return e = encodeURIComponent(e.substr(1, e.length)), React.createElement("div", {
          id: "content"
        }, React.createElement("article", null, React.createElement("div", {
          className: "logo",
          dangerouslySetInnerHTML: {
        ...
        }), React.createElement("h1", null, langLang("welcome"), " Raindrop.io"), React.createElement("br", null), React.createElement("br", null), React.createElement("div", null, React.createElement("a", {
          href: "/account?redirect=" + e,
          className: "button default",
          style: {
            display: "inline-block",
            marginRight: "10px"
          }
        }, langLang("signIn"), " ", React.createElement("span", {
          className: "icon",
          dangerouslySetInnerHTML: {
            __html: icons.forward
          }
        })), React.createElement("a", {
          href: "/account/signup?redirect=" + e,
          className: "button active",
          style: {
            display: "inline-block",
            marginLeft: "10px"
          }
        }, langLang("signUp"), " ", React.createElement("span", {
          className: "icon",
          dangerouslySetInnerHTML: {
            __html: icons.forward
          }
  ...
  27: [function (e, o, a) {
    ...
    o.exports = React.createClass({
      ...
      componentDidMount: function () {
        UserStore.isLogged() ? "clipper" == this.state.platform && UserStore.getConfig("welcome_guide") && (window.location.hash = "#/afterclipper") : window.location.hash = "#login"
      },
      render: function () {
        return React.createElement("div", {
          id: "content"
        }, React.createElement("article", null, React.createElement("header", null, React.createElement("div", {
          className: "logo",
          dangerouslySetInnerHTML: {
            __html: i
          }
        }), React.createElement("h1", null, "Welcome to Raindrop.io")), React.createElement("br", null), React.createElement("br", null), React.createElement("div", {
          className: "subheader"
        }, React.createElement("a", {
          href: "#/collections",
          className: "button active"
  ...
  37: [function (e, o, a) {
    ...
    try {
      ga("send", "event", "welcome", "open")
    } catch (i) {}
    React = e("react"), Reflux = e("reflux"), consts = e("../app/config"), Api = e("../modules/api.js"), t = e("../modules/translate"), window.moment = e("moment"), t.setLang(), t.initJSfile(), _ = e("lodash"), network = e("../modules/network.js"), S = e("string"), Icon = e("../app/components/Helpers/Icon.js"), ls = e("localforage"), UserActions = e("../actions/User"), UserStore = e("../stores/User"), Router = e("react-router");
    var r = Router.DefaultRoute,
      n = Router.Route,
      s = Router.RouteHandler,
      l = Router.NotFoundRoute;
    Link = Router.Link;
    var c = React.createClass({
        ...
        onUserChange: function (e) {
          UserStore.isLoading() || this.setState({
            step: UserStore.isLogged() ? "done" : "login"
          })
        },
        componentDidMount: function () {
          this.unsubscribeUser = UserStore.listen(this.onUserChange), UserStore.onLoad()
        },
        componentWillUnmount: function () {
      ...
      d = {
        loaded: !1,
        load: function () {
          return this.loaded ? !1 : void(this.loaded = !0)
        }
      };
    icons = {
      forward: e("./vector/next.svg"),
      preloader: e("../newtab/images/preloader.svg")
    };
    var p = e("../modules/languages.js");
    langLang = function (e) {
      var o = p.en_US[e];
      try {
        o = p[t.getLang()][e]
    ...
    var m = document.getElementById("welcome-content"),
      u = e("./routes/Start"),
      k = e("./routes/Collections"),
      g = e("./routes/Content"),
      v = e("./routes/Clipper"),
      h = e("./routes/Features"),
      b = e("./routes/Login"),
      f = e("./routes/AfterClipper"),
      y = React.createElement(n, {
        name: "app",
        path: "/",
        handler: c
    ...
    Router.run(y, function (e, o) {
      ...
      React.render(React.createElement(e, null), m, function () {
        document.documentElement.classList.add("show"), d.load()
      })
    })
  }, {
    "../actions/User": 6,
    "../app/components/Helpers/Icon.js": 7,
    "../app/config": 8,
    "../modules/api.js": 10,
    "../modules/languages.js": 11,
    "../modules/network.js": 12,
    "../modules/translate": 14,
    "../newtab/images/preloader.svg": 15,
    "../newtab/manifest.json": 16,
    "../stores/User": 19,
    "./routes/AfterClipper": 21,
    "./routes/Clipper": 22,
    "./routes/Collections": 23,
    "./routes/Content": 24,
    "./routes/Features": 25,
    "./routes/Login": 26,
    "./routes/Start": 27,
